...
Insert INTO pothole (address_id,direction,severity,discovery_date,secure_url,description) VALUES ('1','East','3','2000-01-02 11:04:05', 'https://res.cloudinary.com/tipsindia/image/upload/v1660593331/placeholder-image.png','This pothole has been here for 22 years, its become somewhat of a landmark. My son is now 22 and we ran over this pothole on the way to his birth.');
Insert INTO pothole (address_id,direction,severity,discovery_date,secure_url,description) VALUES ('2','West','7','2021-05-08 9:08:21', 'https://res.cloudinary.com/tipsindia/image/upload/v1660593331/placeholder-image.png','I got pulled over for drunk driving when I was just trying to avoid this pothole, and I wasnt drunk I just had a buzz');
...
Insert INTO pothole (address_id,direction,severity,discovery_date,secure_url,description) VALUES ('4','North','9','2022-03-04 1:06:25', 'https://res.cloudinary.com/tipsindia/image/upload/v1660593331/placeholder-image.png','This customers comment was censored for explicit content');
